...
Assumeutxo is a feature that allows fast bootstrapping of a validating coordinated
...
considered active. This is the "traditional" mode of operation for coordinated.
...
**Failure consideration:** if coordinated unexpectedly halts after `m_stop_use` is set on
...
### COORDINATED restarts sometime after snapshot validation has completed

When coordinated initializes again, what began as the snapshot chainstate is now
