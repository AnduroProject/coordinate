...
This guide describes how to build coordinated, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run coordinated or the GUI.
