...
in your terminal, then install the coordinate-qt package.
...
Coordinate-Qt can display and save QR codes for sending
...
versions of Coordinate-Qt/coordinated.
...
Coordinate-Qt's initial splash screen
...
opening/launching Coordinate-Qt is available only on Linux,
and only if you configure your desktop to launch
Coordinate-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Coordinate-Qt window to start
payment.
...
It is expected that future releases of Coordinate-Qt
