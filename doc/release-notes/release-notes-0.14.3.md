...
Since 0.14.0 the approximate transaction fee shown in Coordinate-Qt when using coin
...
- #10451 `3612219` contrib/init/coordinated.openrcconf: Don't disable wallet by default (Luke Dashjr)
