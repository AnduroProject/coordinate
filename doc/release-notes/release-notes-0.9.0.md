...
over /Applications/Bitcoin-Qt (on Mac) or coordinated/coordinate-qt (on Linux).
...
executable, 'coordinate-cli'. The RPC client code will eventually be removed from
...
- Add separate coordinate-cli client
