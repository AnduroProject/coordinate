...
- #6600 `ef4945f` Include coordinate-tx binary on Debian/Ubuntu (Zak Wilcox)
...
- #6390 `6a73d66` tests: Fix coordinate-tx signing test case (Wladimir J. van der Laan)
...
- #6730 `cb4d6d0` build: Remove dependency of coordinate-cli on secp256k1 (Wladimir J. van der Laan)
...
- #6387 `11576a5` [coordinate-cli] improve error output (Jonas Schnelli)
