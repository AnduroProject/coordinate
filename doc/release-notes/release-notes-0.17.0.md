...
- #12652 `55f490a` coordinate-cli: Provide a better error message when coordinated is not running (practicalswift)
...
- #13725 `07ce278` Fix coordinate-cli --version (Empact)
...
- #13905 `73a09b4` fixed coordinate-cli -help output for help2man (hebasto)
