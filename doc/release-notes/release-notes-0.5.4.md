...
http://gitorious.org/bitcoin/coordinated-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Coordinate-Qt notifications under Growl 1.3.
Increase required age of Coordinate-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Coordinate-Qt over it. (Windows)
