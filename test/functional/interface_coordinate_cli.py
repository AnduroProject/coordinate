...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `coordinate-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and coordinate-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and coordinate-cli getwalletinfo return expected wallet info")
            ...
            # Test coordinate-cli -generate with -rpcwallet in multiwallet mode.
