...
with the coordinated(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a coordinated.  `P2PInterface`
...
Test objects for interacting with a coordinated node over the p2p interface.
