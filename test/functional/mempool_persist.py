...
By default, coordinated will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent coordinated from writing mempool.dat to disk. Verify that `savemempool` fails")
