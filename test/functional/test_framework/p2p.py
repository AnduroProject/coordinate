...
"""Test objects for interacting with a coordinated node over the p2p protocol.

The P2PInterface objects interact with the coordinated nodes under test using the
