...
complete --command coordinated --no-files

# Extract options
function __fish_coordinated_get_options
...
complete \
    --command coordinated \
    --arguments "(__fish_coordinated_get_options --nofiles)"
