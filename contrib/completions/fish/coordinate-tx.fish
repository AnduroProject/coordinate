...
complete --command coordinate-tx --no-files
...
# Extract options
function __fish_coordinate_tx_get_options
...
# Extract commands
function __fish_coordinate_tx_get_commands
...
# Add options
complete \
    --command coordinate-tx \
    --condition "not __fish_bitcoin_seen_cmd (__fish_coordinate_tx_get_commands --commandsonly)" \
    --arguments "(__fish_coordinate_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command coordinate-tx \
    --arguments "(__fish_coordinate_tx_get_commands)" \
    --no-files
