...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Bitcoin/Coordinate-Qt.conf and all else left as default,
    // coordinate-qt should set both -listen and -listenonion to false and start successfully.
