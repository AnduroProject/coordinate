    ...
    : TestingSetup{ChainType::REGTEST, extra_args, coins_db_in_memory, block_tree_db_in_memory}
{
...

    {
        ...
        assert(
            ...
            "2893de4e26f238a3ac7de8cd2836b86f0ea68e591e2970807b4972c9a4a990c3");
    }
}
                                                                     ...
                                                                     bool submit)
{
    ...
    AddCoins(coins_cache, *input_transaction.get(), input_height, preconfCurrentFee, 0, amountAssetIn, nControlN);
